...
define(
  ...
  function() {
    return {
      ...
      'authenticate.kerberos_login': '/authenticate/login/kerberos',

      'authenticate.kerberos_logout': '/authenticate/logout/kerberos',
      ...
      'datagrid.update_query_tool_connection': '/datagrid/initialize/query_tool/update_connection/<int:trans_id>/<int:sgid>/<int:sid>/<int:did>',
      ...
      'schema_diff.compare_database': '/schema_diff/compare_database/<int:trans_id>/<int:source_sid>/<int:source_did>/<int:target_sid>/<int:target_did>',

      'schema_diff.compare_schema': '/schema_diff/compare_schema/<int:trans_id>/<int:source_sid>/<int:source_did>/<int:source_scid>/<int:target_sid>/<int:target_did>/<int:target_scid>',
      ...
      'sqleditor.connect_server_with_user': '/sqleditor/connect_server/<int:sid>/<usr>',
